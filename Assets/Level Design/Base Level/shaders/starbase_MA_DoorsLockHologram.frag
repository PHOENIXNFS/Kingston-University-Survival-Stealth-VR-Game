...
in vec3 var0;
const mat4 cons4 = mat4(1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons5 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons6 = vec3(1.000000, 1.000000, 1.000000);
const float cons7 = float(0.000000);
const float cons8 = float(0.000000);
uniform sampler2D samp0;
const float cons17 = float(1.000000);
in vec3 varnormal;
const vec4 cons25 = vec4(0.000000, 0.000000, 0.000000, 1.000000);
const float cons26 = float(0.000000);
...
void main()
{
	...
	node_bsdf_transparent(cons1, tmp2);
	mapping(var0, cons4, cons5, cons6, cons7, cons8, tmp9);
	node_tex_image(tmp9, samp0, tmp12, tmp13);
	srgb_to_linearrgb(tmp12, tmp15);
	node_emission(tmp15, cons17, facingnormal, tmp19);
	node_mix_shader(tmp13, tmp2, tmp19, tmp23);
	node_output_material(tmp23, cons25, cons26, tmp27);
	linearrgb_to_srgb(tmp27, tmp29);
