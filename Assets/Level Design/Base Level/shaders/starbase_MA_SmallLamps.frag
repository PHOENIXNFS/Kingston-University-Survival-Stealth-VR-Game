...
const float cons16 = float(1.450000);
in vec3 varnormal;
const vec4 cons20 = vec4(0.000000, 0.000000, 0.000000, 1.000000);
...
void main()
{
	...
	node_bsdf_glass(tmp13, cons15, cons16, facingnormal, tmp18);
	node_output_material(tmp18, cons20, cons21, tmp22);
	linearrgb_to_srgb(tmp22, tmp24);
