...
const float cons34 = float(0.000000);
...
void main()
{
	...
	node_bsdf_glossy(tmp13, cons15, facingnormal, tmp17);
	mapping(var0, cons19, cons20, cons21, cons22, cons23, tmp24);
	node_tex_image(tmp24, samp1, tmp27, tmp28);
	node_bsdf_translucent(tmp27, facingnormal, tmp31);
	node_output_material(tmp17, tmp31, cons34, tmp35);
	linearrgb_to_srgb(tmp35, tmp37);
