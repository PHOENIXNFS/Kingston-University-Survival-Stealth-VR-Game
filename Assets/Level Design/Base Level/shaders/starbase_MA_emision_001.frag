...
const float cons15 = float(8.000000);
in vec3 varnormal;
const vec4 cons18 = vec4(0.157434, 0.001667, 0.000000, 1.000000);
const float cons19 = float(0.200000);
const float cons24 = float(0.000000);
...
void main()
{
	...
	node_bsdf_glossy(cons18, cons19, facingnormal, tmp21);
	node_output_material(tmp17, tmp21, cons24, tmp25);
	linearrgb_to_srgb(tmp25, tmp27);
