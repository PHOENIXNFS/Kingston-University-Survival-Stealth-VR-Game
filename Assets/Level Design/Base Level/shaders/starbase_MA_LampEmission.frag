...
const float cons15 = float(5.000000);
in vec3 varnormal;
const mat4 cons19 = mat4(1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 1.000000);
const vec3 cons20 = vec3(0.000000, 0.000000, 0.000000);
const vec3 cons21 = vec3(1.000000, 1.000000, 1.000000);
const float cons22 = float(0.000000);
const float cons23 = float(0.000000);
uniform sampler2D samp1;
const float cons30 = float(0.000000);
const float cons31 = float(1.450000);
const float cons36 = float(0.000000);
...
void main()
{
	...
	node_emission(tmp13, cons15, facingnormal, tmp17);
	mapping(var0, cons19, cons20, cons21, cons22, cons23, tmp24);
	node_tex_image(tmp24, samp1, tmp27, tmp28);
	node_bsdf_glass(tmp27, cons30, cons31, facingnormal, tmp33);
	node_output_material(tmp17, tmp33, cons36, tmp37);
	linearrgb_to_srgb(tmp37, tmp39);
