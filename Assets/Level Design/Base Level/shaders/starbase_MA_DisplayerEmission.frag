...
const float cons15 = float(0.200000);
in vec3 varnormal;
const float cons19 = float(2.000000);
...
void main()
{
	...
	node_emission(tmp13, cons19, facingnormal, tmp21);
	node_output_material(tmp21, tmp17, cons24, tmp25);
